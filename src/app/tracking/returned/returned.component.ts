...
export class ReturnedComponent implements OnInit, OnChanges {
    ...
    constructor(private deliveryService: ConsignmentService, public ngProgress: NgProgress) {
    }
    ...
    getProducts(page: number = 1): void {
        const searchData = {status: 'returned', page: page};
